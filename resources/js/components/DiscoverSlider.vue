                        ...
                        <div class="modal-discover__content">
                            ...
                            <div class="modal-discover__content-wrapper">
                                ...
                                <div class="modal-discover__text">
                                    Established in 1932, the multi-award-winning Regent’s Park Open Air Theatre is one
                                    of the largest theatres in London (1,240 seats) and situated in the beautiful
                                    surroundings of a Royal Park. Passionate about producing first class theatre for and
                                    in our unique setting which inspires, challenges and entertains, we received the
                                    Highly Commended Award for London Theatre of the Year in The Stage Awards 2021.
                                </div>
...
export default {
    ...
    methods: {
        ...
        calculateAndDisplayRoute(directionsService,directionsRenderer) {
            const start = {
                location : { lat: 37.7699298, lng: -122.4469157 },
                icon : this.startPoint,
            }
            const end = {
                location : { lat: 37.7683909618184, lng: -122.51089453697205 },
                icon : this.endPoint,
            }
            directionsService
                .route({
