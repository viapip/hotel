                ...
                <div class="modal-discover__wrapper">
                    <div class="modal-discover__content">
                        ...
                        <div class="modal-discover__content-wrapper">
                            <div class="modal-discover__title">Open Air Theatre Regents Park</div>
                            <div class="modal-discover__text">
                    ...
                    <div class="modal-discover__map"></div>
                </div>
            </div>
            </transition>
