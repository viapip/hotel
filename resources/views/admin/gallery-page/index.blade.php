...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Gallerypage</div>
                    <div class="card-body">
                        <a href="{{ route('admin.gallery-page.create') }}" class="btn btn-success btn-sm" title="Add New GalleryPage">
                            <i class="fa fa-plus" aria-hidden="true"></i> Create
                        </a>

                        <form method="GET" action="{{ url('/admin/gallery-page') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Title</th><th>Image</th><th>Title Seo</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                @foreach($gallerypage as $item)
                                    <tr>
                            ...
                            <div class="pagination-wrapper"> {!! $gallerypage->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
