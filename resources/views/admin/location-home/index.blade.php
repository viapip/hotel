...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">Locationhome</div>
                    <div class="card-body">
                        <a href="{{ route('admin.location-home.create') }}" class="btn btn-success btn-sm" title="Add New LocationHome">
                            <i class="fa fa-plus" aria-hidden="true"></i> Create
                        </a>

                        <form method="GET" action="{{ url('/admin/location-home') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th>#</th><th>Title</th><th>Text</th><th>Image</th><th>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="pagination-wrapper"> {!! $locationhome->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
