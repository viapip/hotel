                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/homepage' . '/' . $homepage->id) }}" accept-charset="UTF-8" style="display:inline">
                            @method('DELETE')
                            @csrf
                            <button type="submit" class="btn btn-danger btn-sm" title="Удалить HomePage" onclick="return confirm(&quot;Confirm delete?&quot;)"><i class="fa fa-trash-o" aria-hidden="true"></i> Удалить</button>
                        </form>
                        <br/>
                        <br/>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Title </th><td> {{ $homepage->title }} </td></tr><tr><th> Banner </th><td> {{ $homepage->banner }} </td></tr><tr><th> About Title </th><td> {{ $homepage->about_title }} </td></tr>
                                </tbody>
                            </table>
                        </div>
